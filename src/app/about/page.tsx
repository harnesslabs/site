    ...
    <section className="text-center">
      ...
      <div className="max-w-3xl mx-auto space-y-4 text-lg text-left text-justify text-gray-700">
        <p>
          ...
          mathematics is more than a tool&mdash;it is the foundation upon which
          all meaningful technology is built.{" "}
          <strong>This is our vision</strong>: to center mathematical thinking
          in software development, where elegant solutions are preferred over
          brute force approaches, and where technology serves to enhance human
